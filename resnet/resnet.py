...
def building_block(inputs, filters, training, projection_shortcut, strides,
                   data_format, squeeze_and_excitation=None):
...
def block_layer(inputs, filters, block_fn, blocks, strides, training, name,
                squeeze_excitation_fn, data_format):
  ...
  inputs = block_fn(inputs, filters, training, projection_shortcut, strides,
                    data_format, squeeze_excitation_fn)
...
class Model(object):
  ...
  def __init__(self, resnet_size, num_classes, num_filters, kernel_size,
               ...
               block_strides, final_size, squeeze_excitation_fn,
               data_format=None):
    ...
    Args:
      ...
      squeeze_excitation_fn: Optional squeeze and excitation function.
    ...
    self.squeeze_excitation_fn = squeeze_excitation_fn
  ...
  def __call__(self, inputs, training):
    ...
    for i, num_blocks in enumerate(self.block_sizes):
      ...
      inputs = block_layer(
          ...
          squeeze_excitation_fn=self.squeeze_excitation_fn,
          data_format=self.data_format)
...
def resnet_model_fn(features, labels, mode, model_class,
                    ...
                    data_format, squeeze_excitation_fn=None, loss_filter_fn=None):
  ...
  model = model_class(resnet_size, data_format, squeeze_excitation_fn)
...
def resnet_main(flags, model_function, input_function):
  ...
  classifier = tf.estimator.Estimator(
      ...
      params={
          ...
          'squeeze_excitation_fn': flags.squeeze_excitation_fn,
      })
...
class ResnetArgParser(argparse.ArgumentParser):
  ...
  def __init__(self, resnet_size_choices=None):
    ...
    self.add_argument(
        '--squeeze_excitation_fn', type=str, default='',
        help="One of {'', 'mean', 'max', 'mean_var'}.")
